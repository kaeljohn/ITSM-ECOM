@php
    ...
    $pageData = $pageData ?? collect($layout['custom_pages'] ?? [])->firstWhere('slug', request('context', 'categories/category1')) ?? collect($layout['custom_pages'] ?? [])->firstWhere('slug', 'store/accessories') ?? [];
    $title = $pageData['title'] ?? 'Category Showcase 1';
