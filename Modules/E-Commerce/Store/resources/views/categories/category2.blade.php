@php
    ...
    $pageData = $pageData ?? collect($layout['custom_pages'] ?? [])->firstWhere('slug', request('context', 'categories/category2')) ?? collect($layout['custom_pages'] ?? [])->firstWhere('slug', 'store/monitors') ?? [];
    $title = $pageData['title'] ?? 'Category Showcase 2';
