        ...
        <div class="w-full relative z-10 group" style="mask-image: linear-gradient(to right, transparent, black 15%, black 85%, transparent); -webkit-mask-image: linear-gradient(to right, transparent, black 15%, black 85%, transparent);">
            ...
            <div class="max-w-[1500px] mx-auto px-6 lg:px-8 relative z-10 py-16 md:py-24">
                <div class="w-full md:w-2/3">
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black text-white tracking-wide mb-4">{{ $pageData['title'] ?? 'Pre-Built PCs' }}</h1>
                    <p class="text-gray-400 text-sm md:text-base leading-relaxed max-w-lg">{{ $pageData['subtitle'] ?? 'Browse our full range of prebuilt gaming PCs. Experience uncompromised performance, ready to ship directly to your door.' }}</p>
                </div>
            </div>
        </div>
    </main>
