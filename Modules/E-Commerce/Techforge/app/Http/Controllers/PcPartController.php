...
class PcPartController extends Controller
{
    public function index(Request $request)
    {
        ...
        $pageData = collect($layout['custom_pages'] ?? [])->firstWhere('slug', 'store/pc-parts') ?? [];

        return view('ecommerce::store.pc-parts', compact('items', 'initialCategory', 'pageData', 'layout'));
    }
}
