...
class DynamicPageController extends Controller
{
    public function show(string $slug, EcommerceClientContext $context)
    {
        ...
        return match ($blueprint) {
            ...
            'accessories' => app(\Modules\Ecommerce\Http\Controllers\AccessoryController::class)->index($request),
            'monitors' => app(\Modules\Ecommerce\Http\Controllers\AccessoryController::class)->monitors($request),
            'pc-parts' => app(\Modules\Ecommerce\Http\Controllers\PcPartController::class)->index($request),
