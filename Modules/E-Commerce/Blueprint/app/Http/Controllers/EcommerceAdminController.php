...
class EcommerceAdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('ecommerce::admin.dashboard', [
            ...
            'activeListingCount' => StorefrontListing::where('is_active', true)->count(),
    ...
    {
        \Log::info('saveLayout request data:', $request->all());
    ...
    public function previewLayout()
    {
        ...
        return view('ecommerce::storefront', [
            'company' => $company,
            'layout' => $layout,
            'storefrontListings' => StorefrontListing::query()->where('is_active', true)->latest()->take(12)->get(),
