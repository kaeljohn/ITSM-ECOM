...
Route::get('/configurator-overview/{id}', function ($id) {
    ...
    return view('ecommerce::plugins.pc-builder.configurator-overview', compact('product', 'allComponents'));
...
Route::get('/custompc-overview/{id}', function ($id) {
    if (str_starts_with($id, 'custom-pc-') || str_starts_with($id, 'custom_')) {
        ...
        return view('ecommerce::plugins.pc-builder.custompc-overview', compact('product'));
    }
...
Route::get('/laptop-overview/{id}', function ($id) {
    ...
    return view('ecommerce::plugins.pc-builder.laptop-overview', compact('product'));
...
Route::get('/prebuilt-overview/{id}', function ($id) {
    ...
    return view('ecommerce::plugins.pc-builder.prebuilt-overview', compact('product'));
...
Route::get('/build-pc', function () {
    ...
    return view('ecommerce::plugins.pc-builder.build-pc', compact('allComponents'));
})->name('build-pc');

Route::get('/pc-configurator', [\Modules\Ecommerce\Http\Controllers\Plugins\CustomPcController::class, 'index'])->name('pc-configurator');
Route::get('/prebuilt-pcs', [\Modules\Ecommerce\Http\Controllers\Plugins\PrebuiltPcController::class, 'index'])->name('prebuilt-pcs');
Route::get('/gaming-laptops', [\Modules\Ecommerce\Http\Controllers\Plugins\LaptopController::class, 'index'])->name('gaming-laptops');
Route::get('/store/accessories', [\Modules\Ecommerce\Http\Controllers\Plugins\AccessoryController::class, 'index'])->name('store.accessories');
Route::get('/store/monitors', [\Modules\Ecommerce\Http\Controllers\Plugins\AccessoryController::class, 'monitors'])->name('store.monitors');
Route::get('/store/pc-parts', [\Modules\Ecommerce\Http\Controllers\Plugins\PcPartController::class, 'index'])->name('store.pc-parts');
Route::get('/forge-store', function () {
    ...
    return view('ecommerce::plugins.pc-builder.forge-store', compact('accessories', 'monitors', 'pcParts'));
})->name('forge-store');
...
Route::get('/{slug}', [\Modules\Ecommerce\Http\Controllers\DynamicPageController::class, 'show'])->where('slug', '.*')->name('dynamic.page');
