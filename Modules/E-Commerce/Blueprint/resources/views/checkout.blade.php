...
<head>
    ...
    <title>{{ $storefrontName ?? config('app.name', 'Nexora Store') }} | Secure Checkout</title>
        ...
        <div class="container mx-auto px-4 max-w-6xl">
            <a href="{{ url('/') }}" class="inline-flex items-center gap-3 group">
                <div class="w-10 h-10 bg-gradient-to-br from-primary to-orange-400 rounded-xl flex items-center justify-center shadow-[0_0_15px_rgba(255,107,0,0.4)] group-hover:shadow-[0_0_25px_rgba(255,107,0,0.6)] transition-all">
                    <img src="{{ Vite::asset('Modules/E-Commerce/Blueprint/resources/img/Techforge_Logo.png') }}" alt="Logo" class="h-6 w-auto object-contain">
                </div>
                <span class="text-xl font-bold tracking-wide text-white tech-font group-hover:text-primary transition-colors">{{ strtoupper($storefrontName ?? 'Store') }}</span>
            </a>
        </div>
    </header>
        ...
        <form id="checkout-form" class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            ...
            <div class="lg:col-span-7 bg-[#0a0a0a] border border-white/5 rounded-xl p-6 lg:p-8 shadow-2xl relative overflow-hidden">
                ...
                <div id="step-3-content" class="space-y-8 hidden relative z-10 animate-fade-in">
                    ...
                    <p class="text-xs text-gray-500 text-center mt-4">By placing your order, you agree to {{ $storefrontName ?? 'Our' }} privacy notice and conditions of use.</p>
                </div>
            </div>
