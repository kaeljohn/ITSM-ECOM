        ...
        <div id="tiers-blocks-panels">
            ...
            <div class="right-panel-content tiers-block-panel" id="panel-tiers-block-{{ $idx }}">
                ...
                <div class="section-content">
                    ...
                    <label>Description
                        <textarea name="tiers_blocks[{{ $idx }}][description]" class="live-input" rows="4" placeholder="Override the listing's description for this card…" style="resize:vertical;">{{ old('tiers_blocks.'.$idx.'.description', $block['description'] ?? '') }}</textarea>
                    </label>
        ...
        <div id="prebuilts-blocks-panels">
            ...
            <div class="right-panel-content prebuilts-block-panel" id="panel-prebuilts-block-{{ $idx }}">
                ...
                <div class="section-content">
                    ...
                    <label>Description
                        <textarea name="prebuilts_blocks[{{ $idx }}][description]" class="live-input" rows="4" placeholder="Override the listing's description for this card…" style="resize:vertical;">{{ old('prebuilts_blocks.'.$idx.'.description', $block['description'] ?? '') }}</textarea>
                    </label>
                    <p style="font-size: 11px; color: #5c5f62; margin-top: -8px;">Leave blank to use the listing's own description.</p>
                    <div style="display:flex; gap:8px; margin-top:16px;">
