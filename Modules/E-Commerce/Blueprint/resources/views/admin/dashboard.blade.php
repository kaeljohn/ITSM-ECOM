        ...
        <tbody>
            @forelse ($recentListings as $listing)
                <tr>
                    ...
                    <td><span style="display:inline-block; padding: 2px 8px; border-radius: 12px; background: {{ $listing->is_active ? '#e8f5e9' : '#f5f5f5' }}; color: {{ $listing->is_active ? '#2e7d32' : '#666' }}; font-size: 12px; font-weight: 500;">{{ $listing->is_active ? 'Active' : 'Draft' }}</span></td>
                    <td>-</td>
