...
<head>
    ...
    <title>{{ $storefrontName }} | PC Configurator</title>
    ...
    <style>
        ...
        .ambient-light-2 {
            ...
            width: 80vw;
            height: 80vw;
            background: radial-gradient(circle, rgba(153, 0, 0, 0.3) 0%, transparent 65%);
            z-index: -1;
            pointer-events: none;
        ...
        ::-webkit-scrollbar-thumb:hover { background: {{ $layout['primary_color'] ?? '#ff6b00' }}; }
        ...
        .step-dot.active {
            background-color: {{ $layout['primary_color'] ?? '#ff6b00' }};
            border-color: {{ $layout['primary_color'] ?? '#ff6b00' }};
        ...
        .step-dot.completed {
            ...
            border-color: {{ $layout['primary_color'] ?? '#ff6b00' }};
            color: {{ $layout['primary_color'] ?? '#ff6b00' }};
        }
        ...
        .visualizer-slot.active {
            ...
            stroke: {{ $layout['primary_color'] ?? '#ff6b00' }};
...
<body class="relative antialiased selection:bg-primary selection:text-white">
    ...
    <div id="product-modal" data-lenis-prevent class="fixed inset-0 bg-black/80 backdrop-blur-md z-[100] opacity-0 pointer-events-none transition-all duration-300 flex items-center justify-center p-4">
                ...
                <div class="flex flex-wrap gap-4 items-end" id="modal-dynamic-filters">
                    ...
                    <div class="ml-auto flex items-center gap-4">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            ...
                            <style>
                                #show-incompatible:checked ~ .dot { transform: translateX(100%); background-color: {{ $layout['primary_color'] ?? '#ff6b00' }}; }
                                    .visualizer-slot {
            transition: all 0.5s ease;
            opacity: 0.2;
            fill: #333;
        ...
        .visualizer-text.active-text {
            fill: {{ $layout['primary_color'] ?? '#ff6b00' }} !important;
            opacity: 1 !important;
    ...
    <div id="success-modal" class="fixed inset-0 bg-black/80 backdrop-blur-sm z-[70] hidden items-center justify-center opacity-0 transition-opacity duration-300">
        <div class="bg-[#0f0f0f] border border-white/10 p-8 rounded-2xl shadow-[0_0_50px_rgba(255,107,0,0.2)] max-w-sm w-full text-center transform scale-95 transition-transform duration-300" id="success-modal-content">
            ...
            <p class="text-gray-400 mb-8 text-sm">Your custom PC has been successfully added to your cart.</p>
    ...
    @vite(['Modules/E-Commerce/Blueprint/resources/js/HomePage/Homepage.js', 'Modules/E-Commerce/Blueprint/resources/js/Pages/BuildPc/BuildPc.js'])
</body>
</html>
