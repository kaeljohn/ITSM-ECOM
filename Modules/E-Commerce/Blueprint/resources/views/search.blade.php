...
<head>
    ...
    <title>Search Results - {{ $storefrontName ?? 'Nexora Store' }}</title>
...
<body class="relative antialiased selection:bg-primary selection:text-white">
    ...
    @vite(['Modules/E-Commerce/Blueprint/resources/js/HomePage/Homepage.js', 'Modules/E-Commerce/Blueprint/resources/js/Category/Category.js', 'Modules/E-Commerce/Blueprint/resources/js/Pages/Search/Search.js'])
</body>
</html>
