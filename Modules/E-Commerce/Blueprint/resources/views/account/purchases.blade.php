...
<head>
    ...
    <title>{{ $storefrontName ?? config('app.name', 'Nexora Store') }} | Cart & Returns</title>
...
<body class="relative antialiased selection:bg-primary selection:text-white">
                ...
                document.write(`
                    <div class="relative flex items-center justify-center">
                        ...
                        <div class="flex items-center relative z-10">
                            <img src="{{ Vite::asset('Modules/E-Commerce/Blueprint/resources/img/Techforge_Logo.png') }}" alt="Logo" class="h-20 w-auto object-contain animate-spin-fast drop-shadow-[0_0_25px_rgba(255,107,0,0.6)]">
                            <span class="text-4xl md:text-5xl font-black text-white tracking-widest animate-slide-text">{{ strtoupper($storefrontName ?? 'Store') }}</span>
                        </div>
                    </div>
                `);
            } else {
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-col ml-8 gap-3 border-l border-white/10 pl-4 py-1">
                                <a href="{{ route('ecommerce.account.profile', ['store' => $store]) }}" class="text-gray-400 hover:text-white transition-colors text-sm">Profile</a>
                        ...
                        <!-- Other Categories -->
                        <a href="{{ route('ecommerce.account.purchases', ['store' => $store]) }}" class="flex items-center gap-3 text-white font-bold text-base mt-4">
                ...
                <div class="lg:col-span-3 liquid-glass rounded-3xl p-6 sm:p-10 border border-white/10 shadow-2xl relative overflow-hidden">
                    ...
                    <div class="relative z-10 flex flex-col gap-6">
                        ...
                        <div class="py-20 flex flex-col items-center justify-center text-center">
                            ...
                            <a href="{{ route('ecommerce.prebuilt-pcs', ['store' => $store]) }}" class="mt-8 bg-gradient-to-r from-primary to-[#ff8c33] hover:from-[#ff8c33] hover:to-primary text-white px-8 py-3 rounded-xl text-sm font-bold transition-all shadow-[0_0_15px_rgba(255,107,0,0.3)] hover:shadow-[0_0_25px_rgba(255,107,0,0.5)] transform hover:-translate-y-0.5">
                                Start Shopping
                            </a>
                        </div>
                    </div>
    ...
    @vite('Modules/E-Commerce/Blueprint/resources/js/HomePage/Homepage.js')
</body>
</html>
